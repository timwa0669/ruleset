...
let body = $response.body.replace(/<script((?!<\/script>).)*(window\.adblock=\!0|adsbygoogle|googlesyndication|googletagmanager|zation|baidu)((?!<\/script>).)*<\/script>/gs, '<script>BindFootLink();</script>');
$done({ body });